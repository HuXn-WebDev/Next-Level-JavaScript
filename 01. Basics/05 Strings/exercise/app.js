...
// 3. Create varialbe name (fullName) & concatenate (favActorFirstName, favActorLastName)
// 4. Create varaible name (uppercase) & CAPITALIZE your fav actore name.
...
// 6. Now append this message to the (message varialbe) `his best show is Silicon Valley`.
